...
#echo "Set Apache rights (write) in laravel directory ($APACHEUSER:$APACHEGROUP - f:664 - d:775)"
#$MODE "chown -R $APACHEUSER:$APACHEGROUP $PROJECTROOTDIR/$SOURCEDIR/{storage,bootstrap/cache}"
#$MODE "find $PROJECTROOTDIR/$SOURCEDIR/storage -type d -print0 | xargs -0 chmod 775"
#$MODE "find $PROJECTROOTDIR/$SOURCEDIR/bootstrap/cache -type d -print0 | xargs -0 chmod 775"
#$MODE "find $PROJECTROOTDIR/$SOURCEDIR/storage -type f -print0 | xargs -0 chmod 664"
#$MODE "find $PROJECTROOTDIR/$SOURCEDIR/bootstrap/cache -type f -print0 | xargs -0 chmod 664"
#$MODE "find $PROJECTROOTDIR/$SOURCEDIR/public/uploads -type d -print0 | xargs -0 chmod 775"
#$MODE "find $PROJECTROOTDIR/$SOURCEDIR/public/uploads -type f -print0 | xargs -0 chmod 664"
